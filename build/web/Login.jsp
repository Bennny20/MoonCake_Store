<%-- 
    Document   : Login
    Created on : Nov 30, 2021, 7:17:18 AM
    Author     : phien
--%>
    ...
    <body>
        <div id="logreg-forms">
            ...
            <form class="form-signin" action="LoginController" method="post">
                ...
                <%--Login--%>
                <input name="txtUserID"  type="text" id="inputEmail" class="form-control" placeholder="UserID..." required="" autofocus="" value="${param.txtUserID}">
